...
ADMIN_CHAT_ID = os.environ.get('ADMIN_CHAT_ID', os.environ.get('ADMIN_CHAT_ID', ''))
...
TG_CHANNEL = os.environ.get('TG_CHANNEL', os.environ.get('TG_CHANNEL', ''))
TG_SELLER = os.environ.get('TG_SELLER', os.environ.get('TG_SELLER', ''))
...
IMAGE_THUMB_QUALITY = int(os.environ.get('IMAGE_THUMB_QUALITY', '75'))
